...
def alignImages(im1, im2):
  ...
  #cv2.imwrite("TestCases/matches.jpg", imMatches)
...
while True:
   ...
   refFilename = "TestCases/test_sample1.jpg"
   imReference = cv2.imread(refFilename, cv2.IMREAD_COLOR)
   # Read image to be aligned
   try:
      path = input("enter file path or exit to close program:\n")   
   except:
      print("an error occured make sure path is correct and add file name")
   if path == "exit":
      break 
